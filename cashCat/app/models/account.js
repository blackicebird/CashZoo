...
Ext.regModel("Account", {
    ...
    proxy: {
        ...
        initialData: [
            ...
            {name: msg.prop("Current Assets"), type: msg.prop("Asset"), code: 11000 , description: msg.prop("Current Assets")},
            {name: msg.prop("Cash in Wallet"), type: msg.prop("Asset"), code: 11100 , description: msg.prop("Cash in Wallet")},
            {name: msg.prop("Petty Cash"), type: msg.prop("Asset"), code: 11200 , description: msg.prop("Petty Cash")},
            {name: msg.prop("Checking Account"), type: msg.prop("Asset"), code: 11300 , description: msg.prop("Checking Account")},
            {name: msg.prop("Savings Account"), type: msg.prop("Asset"), code: 11400 , description: msg.prop("Savings Account")},
            {name: msg.prop("Bank CD"), type: msg.prop("Asset"), code: 11500 , description: msg.prop("Bank CD")},
            {name: msg.prop("Money Market"), type: msg.prop("Asset"), code: 11600 , description: msg.prop("Money Market")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 11700 , description: msg.prop("Others")},

            {name: msg.prop("Fixed Assets"), type: msg.prop("Asset"), code: 12000 , description: msg.prop("Fixed Assets")},
            {name: msg.prop("House"), type: msg.prop("Asset"), code: 12100 , description: msg.prop("House")},
            {name: msg.prop("Vehicle"), type: msg.prop("Asset"), code: 12200 , description: msg.prop("Vehicle")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 12300 , description: msg.prop("Others")},

            {name: msg.prop("Investments"), type: msg.prop("Asset"), code: 13000 , description: msg.prop("Investments")},

            {name: msg.prop("Brokerage Account"), type: msg.prop("Asset"), code: 13100 , description: msg.prop("Brokerage Account")},
            {name: msg.prop("Stock"), type: msg.prop("Asset"), code: 13101 , description: msg.prop("Stock")},
            {name: msg.prop("Mutual Fund"), type: msg.prop("Asset"), code: 13102 , description: msg.prop("Mutual Fund")},
            {name: msg.prop("Bond"), type: msg.prop("Asset"), code: 13103 , description: msg.prop("Bond")},
            {name: msg.prop("Market Index"), type: msg.prop("Asset"), code: 13104 , description: msg.prop("Market Index")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 13105 , description: msg.prop("Others")},

            {name: msg.prop("Retirement"), type: msg.prop("Asset"), code: 13200 , description: msg.prop("Retirement")},
            {name: msg.prop("Stock"), type: msg.prop("Asset"), code: 13201 , description: msg.prop("Stock")},
            {name: msg.prop("Mutual Fund"), type: msg.prop("Asset"), code: 13202 , description: msg.prop("Mutual Fund")},
            {name: msg.prop("Bond"), type: msg.prop("Asset"), code: 13203 , description: msg.prop("Bond")},
            {name: msg.prop("Market Index"), type: msg.prop("Asset"), code: 13204 , description: msg.prop("Market Index")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 13205 , description: msg.prop("Others")},

            {name: msg.prop("Spouse Retirement"), type: msg.prop("Asset"), code: 13300 , description: msg.prop("Spouse Retirement")},
            {name: msg.prop("Stock"), type: msg.prop("Asset"), code: 13301 , description: msg.prop("Stock")},
            {name: msg.prop("Mutual Fund"), type: msg.prop("Asset"), code: 13302 , description: msg.prop("Mutual Fund")},
            {name: msg.prop("Bond"), type: msg.prop("Asset"), code: 13303 , description: msg.prop("Bond")},
            {name: msg.prop("Market Index"), type: msg.prop("Asset"), code: 13304 , description: msg.prop("Market Index")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 13305 , description: msg.prop("Others")},

            {name: msg.prop("Accounts Receivable"), type: msg.prop("Asset"), code: 14000 , description: msg.prop("Accounts Receivable")},


            {name: msg.prop("Equity"), type: msg.prop("Equity"), code: 20000 , description: msg.prop("Equity account")},
            {name: msg.prop("Opening Balances"), type: msg.prop("Equity"), code: 21000 , description: msg.prop("Opening Balances")},
            {name: msg.prop("Retained Earnings"), type: msg.prop("Equity"), code: 22000 , description: msg.prop("Retained Earnings")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 23000 , description: msg.prop("Others")},

            {name: msg.prop("Liabilities"), type: msg.prop("Liability"), code: 30000 , description: msg.prop("Liabilities account")},

            {name: msg.prop("Credit Card"), type: msg.prop("Liability"), code: 31000 , description: msg.prop("Credit Card")},

            {name: msg.prop("Loans"), type: msg.prop("Liability"), code: 32000 , description: msg.prop("Loans")},
            {name: msg.prop("Education Loan"), type: msg.prop("Liability"), code: 32100 , description: msg.prop("Education Loan")},
            {name: msg.prop("Mortgage Loan"), type: msg.prop("Liability"), code: 32200 , description: msg.prop("Mortgage Loan")},
            {name: msg.prop("Vehicle Loan"), type: msg.prop("Liability"), code: 32300 , description: msg.prop("Vehicle Loan")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 32400 , description: msg.prop("Others")},

            {name: msg.prop("Accounts Payable"), type: msg.prop("Liability"), code: 33000 , description: msg.prop("Accounts Payable")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 34000 , description: msg.prop("Others")},


            {name: msg.prop("Income"), type: msg.prop("Income"), code: 40000 , description: msg.prop("Income account")},
            {name: msg.prop("Salary"), type: msg.prop("Income"), code: 41000 , description: msg.prop("Salary")},
            {name: msg.prop("Salary (Spouse)"), type: msg.prop("Income"), code: 42000 , description: msg.prop("Salary (Spouse)")},
            {name: msg.prop("Bonus"), type: msg.prop("Income"), code: 43000 , description: msg.prop("Bonus")},
            {name: msg.prop("Dividend Income"), type: msg.prop("Income"), code: 44000 , description: msg.prop("Dividend Income")},
            {name: msg.prop("Gifts Received"), type: msg.prop("Income"), code: 45000 , description: msg.prop("Gifts Received")},
            {name: msg.prop("Reimbursed Expenses"), type: msg.prop("Income"), code: 46000 , description: msg.prop("Reimbursed Expenses")},
            {name: msg.prop("Sales"), type: msg.prop("Income"), code: 47000 , description: msg.prop("Sales")},

            {name: msg.prop("Interest Income"), type: msg.prop("Income"), code: 48000 , description: msg.prop("Interest Income")},
            {name: msg.prop("Checking Interest"), type: msg.prop("Income"), code: 48100 , description: msg.prop("Checking Interest")},
            {name: msg.prop("Savings Interest"), type: msg.prop("Income"), code: 48200 , description: msg.prop("Savings Interest")},
            {name: msg.prop("CD Interest"), type: msg.prop("Income"), code: 48300 , description: msg.prop("CD Interest")},
            {name: msg.prop("Bond Interest"), type: msg.prop("Income"), code: 48400 , description: msg.prop("Bond Interest")},
            {name: msg.prop("Money Market Interest"), type: msg.prop("Income"), code: 48500 , description: msg.prop("Money Market Interest")},
            {name: msg.prop("Others"), type: msg.prop("Income"), code: 48600 , description: msg.prop("Others")},

            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 49000 , description: msg.prop("Others")},

            {name: msg.prop("Expense"), type: msg.prop("Expense"), code: 50000 , description: msg.prop("Expense account")},
            {name: msg.prop("Adjustment"), type: msg.prop("Expense"), code: 51000 , description: msg.prop("Adjustment")},

            {name: msg.prop("Auto"), type: msg.prop("Expense"), code: 52000 , description: msg.prop("Auto")},
            {name: msg.prop("Gas"), type: msg.prop("Expense"), code: 52100 , description: msg.prop("Gas")},
            {name: msg.prop("Fees"), type: msg.prop("Expense"), code: 52200 , description: msg.prop("Fees")},
            {name: msg.prop("Parking"), type: msg.prop("Expense"), code: 52300 , description: msg.prop("Parking")},
            {name: msg.prop("Repair and Maintenance"), type: msg.prop("Expense"), code: 52400 , description: msg.prop("Repair and Maintenance")},
            {name: msg.prop("Others"), type: msg.prop("Asset"), code: 52500 , description: msg.prop("Others")},

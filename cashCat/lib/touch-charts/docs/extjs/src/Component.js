...
new Ext.Component({
    ...
    initDraggable: function() {
        var me = this,
            ddConfig = Ext.applyIf({
                el: this.getDragEl(),
                constrainTo: me.constrain ? (me.constrainTo || (me.floatParent ? me.floatParent.getTargetEl() : me.el.dom.parentNode)) : undefined
            }, this.draggable);
     ...
     * @param {Boolean/Object} animate If true, the Component is <i>animated</i> into its new position. You may also pass an animation configuration.
     * @return {Ext.Component} this
     */
    ...
    getPosition: function(local) {
        ...
        if ((local === true) || (this.floating && !this.floatParent)) {
     ...
     * @param {String/Ext.Element} animateTarget (optional) <b>only valid for {@link #floating} Components such as
     ...
     * @param {String/Ext.Element/Ext.Component} animateTarget (optional) <b>only valid for {@link #floating} Components such as
     * {@link Ext.window.Window Window}s or {@link Ext.tip.ToolTip ToolTip}s, or regular Components which have been configured

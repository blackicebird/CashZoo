 ...
 * <p>When either specifying child {@link #items} of a Panel, or dynamically {@link Ext.container.Container#add adding} Components
 ...
 * {@link Ext.panel.Header header}, {@link #fbar footer} and body sections.</p>
...
Ext.define('Ext.panel.Panel', {
     ...
     * object or via the {@link Ext.container.Container#defaults defaults} of their parent container.
     */
    minButtonWidth: 75,
...
},
{
    ...
    initComponent: function() {
        ...
        me.addEvents(
            ...
            /**
             * @event beforeclose
             * Fires before the user closes the panel. Return
     ...
     * It will fire the {@link #iconchange} event after completion.

...
Ext.define('Ext.panel.Table', {
     ...
     * The {@link Ext.data.Store Store} the grid should use as its data source (required).
     */
     ...
     * True implies 'both'. False implies 'none'. Defaults to true.
     */
    scroll: true,
    ...
    initComponent: function() {
        ...
        if (!me.hasView) {
            ...
            this.relayEvents(view, [
                 ...
                 * @alias Ext.view.View#selectionchange
                 */
                'selectionchange',
                /**
                 * @event beforeselect
                 * @alias Ext.view.View#beforeselect
                 */
                'beforeselect'
            ]);
        }
    ...
    relayHeaderCtEvents: function (headerCt) {
        this.relayEvents(headerCt, ['columnresize', 'columnmove', 'columnhide', 'columnshow', 'sortchange']);
    },

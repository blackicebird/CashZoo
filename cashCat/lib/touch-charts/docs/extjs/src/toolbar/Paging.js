 ...
 * of data into the <tt>{@link #store}</tt> by passing parameters used for paging criteria.</p>
 *
...
Ext.define('Ext.toolbar.Paging', {
    ...
    initComponent : function(){
        ...
        me.addEvents(
             ...
             * the total number of records in the dataset as returned by the server and the current {@link Ext.data.Store#pageSize pageSize})</div></li>

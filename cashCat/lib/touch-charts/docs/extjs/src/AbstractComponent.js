...
Component after render), see {@link #childEls} and {@link #addChildEls}.
    ...
    /**
     * @cfg {String} xtype The `xtype` configuration option can be used to optimize
     * Component creation and rendering. It serves as a shortcut to the full componet
     * name. For example, the component `Ext.button.Button` has an xtype of `button`.
     *
     * You can define your own xtype on a custom {@link Ext.Component component} by
     * specifying the {@link Ext.Class#alias alias} config option with a prefix of
     * `widget`. For example:
     *
     *     Ext.define({
     ...
     *     })
     *
     * Any Component can be created implicitly
     ...
     * this can make a noticeable improvement in performance.
     *
     ...
     *     };
     *
     * In the first example, the button will always be created immediately
     ...
     * button will never be created and will never consume any resources whatsoever.
     */
    ...
    /**
     * Ensures that the plugins array contains fully constructed plugin instances. This
     * converts any configs into their appropriate instances.
     */
     ...
     * <p>Register a Container configured <code>floating: true</code> with this Component's {@link Ext.ZIndexManager ZIndexManager}.</p>
     ...
     * @param {String/Number/Ext.Element/HTMLElement} position Index, element id or element you want
...
alert(t.getXTypes());  // alerts 'component/field/textfield'
     ...
     * @param {Boolean} deep (optional) Pass <code>true</code> to interrogate the visibility status of all
     ...
     * @param {Number/String/Object} width The new width to set. This may be one of:<div class="mdetail-params"><ul>

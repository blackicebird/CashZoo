 ...
 * tab property on the child item. For example:
 *
 ...
 * object for a panel. For example:
 *
 *     var tabs = Ext.Create('Ext.tab.Panel', {
 *         items: [
 *             {
 ...
 * with an config object for a panel. For example:
 *
 *     var tabs = Ext.Create('Ext.tab.Panel', {
 *         items: [
 *             {
...
Ext.define('Ext.tab.Panel', {
     ...
     * This is to ensure that the title of the panel does not appear twice. Defaults to true.
     */
     ...
     * The minimum width for a tab in the {@link #tabBar}. Defaults to <code>undefined</code>.
     */
    minTabWidth: undefined,

    /**
     * @cfg {Number} maxTabWidth The maximum width for each tab. Defaults to <code>undefined</code>.
     */

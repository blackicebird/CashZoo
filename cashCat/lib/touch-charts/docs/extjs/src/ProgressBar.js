 ...
 * @cfg {Number} value A floating point value between 0 and 1 (e.g., .5, defaults to 0)
 * @cfg {String} text The progress bar text (defaults to '')
 * @cfg {String/HTMLElement/Ext.Element} textEl The element to render the progress text to (defaults to the progress
...
Ext.define('Ext.ProgressBar', {
    ...
    */
     ...
     * @param {Number} value (optional) A floating point value between 0 and 1 (e.g., .5, defaults to 0)

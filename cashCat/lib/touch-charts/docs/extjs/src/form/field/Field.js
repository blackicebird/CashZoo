...
Ext.define('Ext.form.field.Field', {
    ...
    /**
     * @cfg {Object} value A value to initialize this field with (defaults to undefined).
     */
     ...
     * {@link #validitychange validitychange event} if the validity has changed, and</li>

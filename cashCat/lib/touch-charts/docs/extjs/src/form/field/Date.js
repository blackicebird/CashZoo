...
disabledDates: ["^03"]
     ...
     * @param {String[]} disabledDates An array of date strings (see the <tt>{@link #disabledDates}</tt> config
     ...
     * @param {Number[]} disabledDays An array of disabled day indexes. See the <tt>{@link #disabledDays}</tt>

...
var combo = new Ext.form.field.ComboBox({
     ...
     * {@link Ext.view.BoundList#pageSize limit} parameters. Only applies when <code>{@link #queryMode} = 'remote'</code>
...
var combo = new Ext.form.field.ComboBox({
     ...
     * The id, DOM node or {@link Ext.Element} of an existing HTML <code>&lt;select&gt;</code> element to
     ...
     * @param {Boolean} rawQuery Pass as true if the raw typed value is being used as the query string. This
     * causes the resulting store load to leave the raw value undisturbed.

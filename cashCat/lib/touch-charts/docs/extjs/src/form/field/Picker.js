...
Ext.define('Ext.form.field.Picker', {
    ...
    /**
     * Perform the alignment on the picker using the class defaults
     * @private
     */
    doAlign: function(){
        var me = this,
     ...
     * by subclasses of Picker. The current field should also be passed as a configuration
     * option to the picker component as the pickerField property.
     * @return {Ext.Component} The picker component
     */

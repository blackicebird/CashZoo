...
Ext.define('Ext.form.CheckboxGroup', {
    ...
    /**
     * @cfg {Ext.form.field.Checkbox[]/Object[]} items An Array of {@link Ext.form.field.Checkbox Checkbox}es or Checkbox config objects
     * to arrange in the group.
     */

    /**
     * @cfg {String/Number/Number[]} columns Specifies the number of columns to use when displaying grouped

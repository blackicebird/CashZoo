...
*/
Ext.test.session.addTest('Ext.container.Container', {
    name: 'Test Ext.container.Container methods',
    ...
    test_cascade: function(){
        var ct = new Ext.container.Container({itemId: 'ct', depth: 0}),
            i, 
            j, 
            k,
            ci,
    ...
    test_remove: function(){
        ...
        ct = new Ext.container.Container({items: items});

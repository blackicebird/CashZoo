 ...
 */
(function() {
    var suite  = Ext.test.session.getSuite('Ext.form.Basic'),
        assert = Y.Assert;
    ...
    function buildForm(config) {
        ...
        return new Ext.form.Basic(null, config);
    };
    ...
    suite.add(new Y.Test.Case({
        ...
        testGetEL: function() {
            var form = new Ext.form.Basic(this.el, {});
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp: function() {
            ...
            this.item2 = buildFormItem({name: 'email', getValue: function() {return 'ed@sencha.com';}});
            this.item3 = buildFormItem({name: 'phone', getValue: function() {return '333';}});
        ...
        testGetFieldValues: function() {
            ...
            assert.areEqual('ed@sencha.com', values.email);

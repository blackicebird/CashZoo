...
describe("Ext.form.field.Radio", function() {
    ...
    it("should render a button input with role='radio'", function(){
        var component = new Ext.form.field.Radio({
            name: 'test',
            renderTo: Ext.getBody()
        });
        expect(component.inputEl.dom.type.toLowerCase()).toEqual("button");
        expect(component.inputEl.dom.getAttribute('role')).toEqual("radio");
        radios = [component];
    });

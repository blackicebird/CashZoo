...
describe("Ext.form.field.Text", function() {
    ...
    beforeEach(function() {
        makeComponent = function(config) {
            ...
            component = new Ext.form.field.Text(config);
        };
    ...
    describe('fieldStyle', function() {
        it("should set the style of the inputEl when rendered", function() {
            ...
            var borderColor = component.inputEl.getStyle('border-color');
            expect(borderColor === 'red' || borderColor ==='red red red red' || borderColor === '#ff0000').toBe(true);
        });
        describe('setFieldStyle method', function() {
            it("should apply the argument as the style of the rendered inputEl", function() {
                ...
                component.setFieldStyle('border-color:red;');
                var borderColor = component.inputEl.getStyle('border-color');
                expect(borderColor === 'red' || borderColor ==='red red red red' || borderColor === '#ff0000').toBe(true);
            });
    ...
    describe('label hiding', function() {
        describe('hideEmptyLabel', function() {
            it("should not render a label when fieldLabel is empty", function() {
                makeComponent({
                    renderTo: Ext.getBody()
                });
        ...
        describe('hideLabel', function() {
            it("should not render a label when true", function() {
                makeComponent({
                    renderTo: Ext.getBody(),
                    hideLabel: true,
                    fieldLabel: 'foo'
            ...
            it("should hide the label even if hideEmptyLabel=false", function() {
                makeComponent({
                    renderTo: Ext.getBody(),
                    hideLabel: true,
                    fieldLabel: '',

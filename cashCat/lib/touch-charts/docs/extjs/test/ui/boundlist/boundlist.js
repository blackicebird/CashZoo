...
Ext.onReady(function(){
    ...
    var single = new Ext.form.field.ComboBox({
    ...
    var multi = new Ext.form.field.ComboBox({
    ...
    var singleNotEditable = new Ext.form.field.ComboBox({
        editable: false,
        fieldLabel: 'Single Combo',
        displayField: 'company',
        name: 'single',
    ...
    var multipleNotEditable = new Ext.form.field.ComboBox({
        editable: false,
        multiSelect: true,
    ...
    var remote = new Ext.form.field.ComboBox({
        id: 'remote',
        fieldLabel: 'Remote',
        displayField: 'state',
        valueField: 'abbr',
    ...
    var custTpl = new Ext.form.field.ComboBox({
